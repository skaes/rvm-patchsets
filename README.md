...
with the following commands:
    ...
    rvm reinstall 2.6.1 --patch railsexpress
...
the patches:
    ...
    rvm install 2.6.1 --patch railsexpress -n railsexpress
...
or use rvm's name parsing magic:
    ...
    rvm install 2.6.1-railsexpress --patch railsexpress
...
there's no guarantee. The following versions are currently supported:
    ...
    2.6.0       # outdated, please use 2.6.1
...
To enable heap dump support, pass the --enable-gcdebug option to the rvm install command.
    ...
    rvm install 2.6.1 --patch railsexpress -n gcdebug -C --enable-gcdebug
