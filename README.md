...
there's no guarantee. The following versions are currently supported:
    ...
    2.2.0       # outdated, please use 2.2.9
    2.2.1       # outdated, please use 2.2.9
    2.2.2       # outdated, please use 2.2.9
    2.2.3       # outdated, please use 2.2.9
    2.2.4       # outdated, please use 2.2.9
    2.2.5       # outdated, please use 2.2.9
    2.2.6       # outdated, please use 2.2.9
    2.2.7       # outdated, please use 2.2.9
    2.2.8       # outdated, please use 2.2.9
    2.2.9       # current rvm default for 2.2 branch
    2.3.3       # outdated, please use 2.3.6
    2.3.4       # outdated, please use 2.3.6
    2.3.5       # outdated, please use 2.3.6
    2.3.6       # current rvm default for 2.3 branch
    2.4.0       # outdated, please use 2.4.3
